  ...
  <table class="tableMain">
    <tr>
      <td><input name="action" type="hidden" id="action" value="checkEvent" />
        <input name="eventID" type="hidden" id="eventID" value="<?php echo $externals['eventID']; ?>" /><input type="submit" name="SubmitButton" id="SubmitButton" value="<?php _e( 'SubmitMENOW', 'book-a-room' ); ?>" /></td>
    </tr>
  </table>
  <h3>&nbsp;</h3>
