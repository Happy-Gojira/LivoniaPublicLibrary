	...
	<table class="tableMain">
		...
		<tr>
			...
			<tr>
				...
				<td><input name="bookaroom_hide_contract" type="checkbox" id="bookaroom_hide_contract" value="TRUE" <?php echo ( empty( $options[ 'bookaroom_hide_contract'] ) ) ? NULL : ' checked="checked"'; ?>></td>
			</tr>
			<tr>
				<td nowrap="nowrap">
