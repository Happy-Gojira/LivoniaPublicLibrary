...
== Changelog ==
=== 2.7.6.5 =* I added a new feature that allows you to export to clipboard or open an email with every registrant's address for an event in case you need to contact them.
